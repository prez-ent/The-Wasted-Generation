    ...
    <div id="page-practitioners">
      <div className="prac-hero">
        <div className="container">
          ...
          <p className="sub">TGW is a network for practitioners who have genuinely done the thing — not people looking for their next job. You bring the expertise. We bring the structure, the clients, the protection, and the economics.</p>
